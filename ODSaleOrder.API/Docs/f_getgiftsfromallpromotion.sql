...
BEGIN
	RETURN QUERY
					...
					(
							...
							AND (item."FromUnit" = item."PurchaseUnit" OR item."FromUnit" = tp."PackingUomId") AND item."ToUnit" = item."BaseUnit" AND item."ItemType" = 'STOCK' AND item."Competitor" = 'f'
