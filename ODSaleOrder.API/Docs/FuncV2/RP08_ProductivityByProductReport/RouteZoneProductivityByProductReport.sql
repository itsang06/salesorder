CREATE OR REPLACE FUNCTION RouteZoneProductivityByProductReport (
...
select * from RouteZoneProductivityByProductReport('IT01','1000122', null, 'SO_ST_CANCEL,SO_ST_DELIVERED','2023-10-01 00:00:00','2023-12-31 23:59:59');
