CREATE OR REPLACE FUNCTION DisProductivityBySalesReport (
...
SELECT * 
from DisProductivityBySalesReport('IT01', '1000122', null, 'SO_ST_OPEN,SO_ST_SHIPPING,SO_ST_WAITINGSHIPPING,SO_ST_DELIVERED,SO_ST_PARTIALDELIVERED,SO_ST_FAILED,SO_ST_CONFIRM,SO_ST_COMPLETE_DRAFT', '2023-10-01', '2024-01-02')