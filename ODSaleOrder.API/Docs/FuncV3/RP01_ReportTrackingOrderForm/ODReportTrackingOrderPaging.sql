DROP FUNCTION ODReportTrackingOrderPaging (
...
CREATE OR REPLACE FUNCTION ODReportTrackingOrderPaging (
    distributorCode VARCHAR,
    salesRepID VARCHAR, 
    status VARCHAR, 
    fromDate TIMESTAMP,
...
select * from ODReportTrackingOrderPaging ('p0401241',null, 'SO_ST_OPEN,SO_ST_SHIPPING,SO_ST_WAITINGSHIPPING,SO_ST_DELIVERED,SO_ST_PARTIALDELIVERED,SO_ST_FAILED,SO_ST_CONFIRM,SO_ST_COMPLETE_DRAFT','2024-01-01','2024-03-16', 1, 10, 'osp0401241');