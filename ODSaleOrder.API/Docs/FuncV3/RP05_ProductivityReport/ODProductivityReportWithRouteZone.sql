CREATE OR REPLACE FUNCTION ODProductivityReportWithRouteZone (
...
select * from ODProductivityReportWithRouteZone('p0401241', null, '2024-01-01', '2024-03-16', 'osp0401241');