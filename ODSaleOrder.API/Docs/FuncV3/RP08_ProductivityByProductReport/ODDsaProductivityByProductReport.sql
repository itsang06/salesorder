CREATE OR REPLACE FUNCTION ODDsaProductivityByProductReport(
...
select * 
from ODDsaProductivityByProductReport('IT02', 'p0401241', 'SO_ST_CANCEL,SO_ST_DELIVERED', '2024-01-01', '2024-03-16', 'osp0401241');