...
ADD COLUMN "OSOutletCode" character varying(100) NULL,
ADD COLUMN "DistributorName" character varying(255) NULL;
            ...
            FOREACH schemaname IN ARRAY schema_list LOOP
							BEGIN
									...
									THEN
											...
											table_sql := 'ALTER TABLE ' || quote_ident(schemaname) || '."SO_OrderInformations"
                                                                                                    ADD COLUMN "OSOutletCode" character varying(100) NULL,
                                                                                                    ADD COLUMN "DistributorName" character varying(255) NULL;';
											EXECUTE table_sql;
									END IF;
