ALTER TABLE public."FFASoOrderInformations"
ADD COLUMN "ErrorMessage" character varying(255) NULL;
            ...
            FOREACH schemaname IN ARRAY schema_list LOOP
							BEGIN
									...
									THEN
											...
											table_sql := 'ALTER TABLE ' || quote_ident(schemaname) || '."FFASoOrderInformations" ADD COLUMN "ErrorMessage" character varying(255) NULL;';
											EXECUTE table_sql;
									END IF;
