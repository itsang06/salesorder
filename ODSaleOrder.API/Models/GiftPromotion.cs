namespace ODSaleOrder.API.Models
{
    public class GiftPromotion
    {
        ...
        public int? LevelOrderAmount { get; set; }
        ...
        public string IsApplyBudget { get; set; }
        public string BudgetValueCode { get; set; }
        public string BudgetQtyCode { get; set; }
        public string IsBudgetQtyBookOver { get; set; }
        public string IsBudgetValueBookOver { get; set; }
        public string ItemCode { get; set; }
        public string ItemDescription { get; set; }
        public string BaseUnit { get; set; }
        public int? ConversionFactor { get; set; }
        public int? TotalFreeQuantity { get; set; } // So luong san pham tang tren line hang



        public decimal? OrgTotalAmount { get; set; }
